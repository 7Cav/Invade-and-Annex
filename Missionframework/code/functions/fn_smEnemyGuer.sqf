...
_infTeams = ["OG_InfSentry","OG_InfSquad","OG_InfSquad_Weapons","OG_InfTeam","OG_InfTeam_AT","OG_ReconSentry","OG_SniperTeam_M","I_E_ShotG","I_E_InfTeamE","I_E_InfSquadE"];
...
for '_x' from 0 to (6 + (random 3)) do {

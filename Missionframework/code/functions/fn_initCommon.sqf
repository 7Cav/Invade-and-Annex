...
private _code = {};
{
	...
	['QS_BTextures','code\config\QS_backpackTextures.sqf'],
	['AR_Advanced_Rappelling_Install','code\scripts\AR_AdvancedRappelling_ext.sqf'],
	['QS_aoHQ0',(format ['code\config\hqCompositions\%1\QS_composition0.sqf',_environment])],
	...
	['ALX_aoHQ25',(format ['code\config\hqCompositions\%1\alx_composition25.sqf',_environment])],
	['ALX_aoHQ26',(format ['code\config\hqCompositions\%1\alx_composition26.sqf',_environment])],
	['ALX_aoHQ27',(format ['code\config\hqCompositions\%1\alx_composition27.sqf',_environment])],
	['ALX_aoHQ28',(format ['code\config\hqCompositions\%1\alx_composition28.sqf',_environment])],
	['ALX_aoHQ29',(format ['code\config\hqCompositions\%1\alx_composition29.sqf',_environment])],
	['ALX_aoHQ30',(format ['code\config\hqCompositions\%1\alx_composition30.sqf',_environment])],
	['ALX_aoHQ31',(format ['code\config\hqCompositions\%1\alx_composition31.sqf',_environment])],

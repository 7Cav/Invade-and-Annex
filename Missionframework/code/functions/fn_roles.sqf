...
if (_type isEqualTo 'INIT_ROLE') exitWith {
	...
	if (_role in ['rifleman','o_rifleman']) then {
		_traitsData = [
			[['medic',FALSE,FALSE]],
			[['uavhacker',FALSE,FALSE]],
			[['engineer',FALSE,FALSE]],
	...
	if (_role isEqualTo 'heavy_gunner') then {
		_traitsData = [
			[['medic',FALSE,FALSE]],
			[['uavhacker',FALSE,FALSE]],
			[['engineer',FALSE,FALSE]],
	...
	if (_role in ['rifleman_lat','rifleman_hat','rifleman_aa']) then {
		_traitsData = [
			[['medic',FALSE,FALSE]],
			[['uavhacker',FALSE,FALSE]],
			[['engineer',FALSE,FALSE]],
	...
	if (_role isEqualTo 'leader') then {
		_traitsData = [
			[['medic',FALSE,FALSE]],
			[['uavhacker',FALSE,FALSE]],
			[['engineer',FALSE,FALSE]],
			[['explosiveSpecialist',TRUE,FALSE]],
			[['audibleCoef',0.9,FALSE]],
			[['camouflageCoef',0.9,FALSE]],
			[['loadCoef',0.9,FALSE]],
			[['QS_trait_leader',TRUE,TRUE]],
			[['QS_trait_pilot',FALSE,TRUE]],
			[['QS_trait_AT',FALSE,TRUE]],
			[['QS_trait_gunner',FALSE,TRUE]],
			[['QS_trait_HQ',FALSE,TRUE]],

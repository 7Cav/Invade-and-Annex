...
];
{
	...
	['RscSpectator_allowFreeCam',TRUE,TRUE],
...
['Initialize',[FALSE,(missionNamespace getVariable ['McD_missionConfig_squadSizeLimit',16]),FALSE,'']] call (missionNamespace getVariable 'BIS_fnc_dynamicGroups'); 
...
missionNamespace setVariable [
	'QS_hqArray',
	[
		(missionNamespace getVariable 'QS_aoHQ0'),
		...
		(missionNamespace getVariable 'ALX_aoHQ25'),
		(missionNamespace getVariable 'ALX_aoHQ26'),
		(missionNamespace getVariable 'ALX_aoHQ27'),
		(missionNamespace getVariable 'ALX_aoHQ28'),
		(missionNamespace getVariable 'ALX_aoHQ29'),
		(missionNamespace getVariable 'ALX_aoHQ30'),
		(missionNamespace getVariable 'ALX_aoHQ31')
	],
	FALSE
];
missionNamespace setVariable [
...
0 spawn (missionNamespace getVariable 'McD_fnc_sCommandChannelMgr');

...
if (_side isEqualTo EAST) exitWith {
	...
	if (_type isEqualTo 'O_R_reconTeam') then {_return = [['O_R_recon_TL_F','SERGEANT'],['O_R_recon_M_F','CORPORAL'],['O_R_recon_GL_F','SERGEANT'],['O_R_recon_AR_F','PRIVATE'],['O_R_recon_LAT_F','PRIVATE']];breakTo 'main';};
	if (_type isEqualTo 'I_E_InfSquadE') then {_return = [['I_E_Soldier_SL_F','SERGEANT'],[(selectRandom ['I_E_Soldier_AT_F','I_E_Soldier_LAT2_F']),'PRIVATE'],['I_E_Soldier_TL_F','SERGEANT'],['I_E_Soldier_GL_F','PRIVATE'],['I_E_RadioOperator_F','CORPORAL'],['I_E_soldier_M_F','PRIVATE'],['I_E_Soldier_AR_F','PRIVATE'],['I_E_Soldier_Pathfinder_F','PRIVATE']];breakTo 'main';};
	if (_type isEqualTo 'I_E_InfTeamE') then {_return = [['I_E_Soldier_TL_F','SERGEANT'],['I_E_Soldier_AR_F','CORPORAL'],['I_E_Soldier_GL_F','PRIVATE'],['I_E_Soldier_Pathfinder_F','PRIVATE'],['I_E_Soldier_LAT_F','PRIVATE']];breakTo 'main';};
	if (_type isEqualTo 'I_E_ShotG') then {_return = [['I_E_Soldier_TL_F','SERGEANT'],['I_E_Soldier_AR_F','CORPORAL'],['I_E_Soldier_Pathfinder_F','PRIVATE'],['I_E_Soldier_Pathfinder_F','PRIVATE'],['I_E_Soldier_Pathfinder_F','PRIVATE']];breakTo 'main';};
	_return;
};
...
if (_side isEqualTo RESISTANCE) exitWith {
	...
	if (_type isEqualTo 'I_E_InfSquad') then {_return = [['I_E_Soldier_SL_F','SERGEANT'],[(selectRandom ['I_E_Soldier_AT_F','I_E_Soldier_LAT2_F']),'PRIVATE'],['I_E_Soldier_TL_F','SERGEANT'],['I_E_Soldier_GL_F','PRIVATE'],['I_E_RadioOperator_F','CORPORAL'],['I_E_soldier_M_F','PRIVATE'],['I_E_Soldier_AR_F','PRIVATE'],['I_E_Soldier_Pathfinder_F','PRIVATE']];breakTo 'main';};
	...
	if (_type isEqualTo 'I_L_CriminalGang') then {_return = [['I_L_Looter_Rifle_F','SERGEANT'],['I_L_Looter_SG_F','PRIVATE'],['I_L_Looter_Rifle_F','CORPORAL'],['I_L_Looter_SMG_F','PRIVATE'],['I_L_Criminal_SG_F','SERGEANT'],['I_L_Criminal_SMG_F','CORPORAL']];breakTo 'main';};
	if (_type isEqualTo 'I_L_CriminalSentry') then {_return = [['I_L_Looter_SG_F','SERGEANT'],['I_L_Looter_Rifle_F','PRIVATE']];breakTo 'main';};
	if (_type isEqualTo 'I_L_LooterGang') then {_return = [['I_L_Criminal_SG_F','SERGEANT'],['I_L_Looter_SG_F','PRIVATE'],['I_L_Looter_Rifle_F','CORPORAL']];breakTo 'main';};
	if (worldName isEqualTo 'Tanoa') then {

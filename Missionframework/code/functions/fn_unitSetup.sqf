...
if ((side _unit) in [EAST,RESISTANCE]) then {
	_excluded = [
		...
		'i_diver_f','i_diver_exp_f','i_diver_tawl_f','i_l_criminal_sg_f','i_l_looter_sg_f','i_l_hunter_f','i_l_looter_rifle_f','i_l_criminal_smg_f','i_l_looter_pistol_f','i_l_looter_smg_f',
		'i_e_soldier_pathfinder_f','I_E_Soldier_TL_F','i_e_soldier_cbrn_f', 'i_e_scientist_f', 'i_e_scientist_unarmed_f',
		...
		'i_e_helipilot_f','i_pilot_f','i_helipilot_f','i_fighter_pilot_f','o_t_pilot_F','o_t_helipilot_F','o_pilot_f','o_helipilot_f','o_fighter_pilot_f','b_pilot_f','b_helipilot_f','b_fighter_pilot_f',
		'b_t_pilot_f','b_t_helipilot_f','b_w_pilot_f'
	];
	// Add radio backpack
	if (_unitType in [
		...
		'o_v_soldier_tl_ghex_f','o_r_jtac_f','o_r_soldier_tl_f','o_r_recon_jtac_f','o_r_recon_tl_f','i_soldier_sl_f','o_soldieru_sl_f','I_E_Soldier_SL_F'
	]) then {
		if (_unitType in [
		...
		if (_unitType in [
			'o_r_jtac_f','o_r_soldier_tl_f','o_r_recon_jtac_f','o_r_recon_tl_f','I_E_Soldier_SL_F'
		]) then {
	...
	if (_unitType in [
		...
		_weapons = [
			'lmg_03_f',0.25,
			(selectRandom ['lmg_mk200_f','lmg_mk200_black_f']),0.2,
			'lmg_zafir_f',0.2,
			'arifle_rpk12_f',0.2,
			'mmg_01_hex_f',0.125
		];
		...
		_unit addPrimaryWeaponItem (selectRandom [
			'optic_ams','optic_ams_khk','optic_khs_blk',
			'optic_lrps','optic_lrps_ghex_f',
	...
	if (_unitType in [
		...
		_weaponHandled = TRUE;
		_weapons = [
			(selectRandom ['arifle_ak12_gl_f','arifle_ak12_gl_arid_f','arifle_ak12_gl_lush_f']),0.2,
			(selectRandom ['arifle_ctar_gl_blk_f','arifle_ctar_gl_ghex_f','arifle_ctar_gl_hex_f']),0.2,
		...
		_unit addPrimaryWeaponItem (selectRandom [
			/*/'optic_ams','optic_ams_khk','optic_khs_blk','optic_khs_hex',
	...
	if (_unitType in [
		...
		if (worldName in ['Tanoa']) then {
			_weapons = [
				(selectRandom ['srifle_dmr_07_blk_f','srifle_dmr_07_ghex_f','srifle_dmr_07_hex_f']),0.2,
				(selectRandom ['srifle_dmr_05_blk_f','srifle_dmr_05_hex_f','srifle_dmr_05_tan_f']),0.2,
				...
				(selectRandom ['arifle_msbs65_mark_f','arifle_msbs65_mark_black_f','arifle_msbs65_mark_camo_f','arifle_msbs65_mark_sand_f']),0.2,
				'srifle_ebr_f',0.1,
				'srifle_dmr_01_f',0.1
			];
		};
		...
		_unit addPrimaryWeaponItem (selectRandom ['optic_ams','optic_ams_khk','optic_khs_blk','optic_khs_hex','optic_khs_tan','optic_lrps','optic_lrps_ghex_f','optic_lrps_tna_f']);
	};
	// spotter
	if (_unitType in [
	...
	if (!(_weaponHandled)) then {
		if (!(_unitType in _excluded)) then {
			...
			_weaponHandled = TRUE;
			_weapons = [
				(selectRandom ['arifle_ak12_f','arifle_ak12_arid_f','arifle_ak12_lush_f']),0.2,
				'arifle_akm_f',0.05,
				(selectRandom ['arifle_ctar_blk_f','arifle_ctar_ghex_f','arifle_ctar_hex_f']),0.1,
				'arifle_katiba_f',0.2,
				(selectRandom ['arifle_mk20_plain_f','arifle_mk20_f']),0.05,
				(selectRandom ['arifle_msbs65_f','arifle_msbs65_black_f','arifle_msbs65_camo_f','arifle_msbs65_sand_f']),0.2,
				(selectRandom ['arifle_msbs65_mark_f','arifle_msbs65_mark_black_f','arifle_msbs65_mark_camo_f','arifle_msbs65_mark_sand_f']),0.2,
				'arifle_trg21_f',0.05
			];
			if (worldName in ['Tanoa']) then {
			...
			_unit addPrimaryWeaponItem (selectRandom [
				/*/'optic_ams','optic_ams_khk',
				'optic_khs_blk','optic_khs_hex','optic_khs_tan',
				'optic_lrps','optic_lrps_ghex_f','optic_lrps_tna_f',
				/*/
				'optic_arco','optic_arco_arid_f','optic_arco_blk_f','optic_arco_ghex_f','optic_arco_lush_f','optic_arco_ak_arid_f','optic_arco_ak_blk_f',
				'optic_arco_ak_lush_f','optic_erco_blk_f','optic_erco_khk_f','optic_erco_snd_f','optic_mrco','optic_hamr','optic_hamr_khk_f'

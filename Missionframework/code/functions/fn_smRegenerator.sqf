...
if (_playerCount > 10) then {_unitCount = 24;_groupSize = 6;_tankCount = 2;} else {_unitCount = 16;_groupSize = 6;_tankCount = 1;};
if (_playerCount > 20) then {_unitCount = 28;_groupSize = 10;_tankCount = 2;};
if (_playerCount > 30) then {_unitCount = 28;_groupSize = 10;_tankCount = 2;};
if (_playerCount > 40) then {_unitCount = 32;_groupSize = 12;_tankCount = 3;};
if (_playerCount > 50) then {_unitCount = 32;_groupSize = 12;_tankCount = 3;};
_tankCount = 2;
...
_task = [
	...
	TRUE,
	[
		'The enemy has deployed a high frequency ionic device which activates wound-healing technology in CSAT uniforms. While the device is active, the enemy may be harder to kill.<br/><br/>Send a team to destroy it!<br/><br/>Be aware this can be a difficult mission!',
		'Regenerator',
		'Regenerator'
	],
...
for '_x' from 0 to 1 step 0 do {
	...
	if (_playerCount > 10) then {_unitCount = 20;_groupSize = 6;} else {_unitCount = 16;_groupSize = 6;};
	if (_playerCount > 20) then {_unitCount = 24;_groupSize = 8;};
	if (_playerCount > 30) then {_unitCount = 24;_groupSize = 8;};
	if (_playerCount > 40) then {_unitCount = 28;_groupSize = 10;};
	if (_playerCount > 50) then {_unitCount = 28;_groupSize = 10;};

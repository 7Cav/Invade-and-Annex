...
[_pos,_dir,_newCasType,_isCarrier] spawn {
	...
	if ((toLower _newCasType) in ['i_plane_fighter_04_f']) then {
		_casJet removeWeapon 'PylonRack_Missile_AMRAAM_C_x1';
		_casJet removeWeapon 'PylonRack_Missile_AMRAAM_D_x1';
		_casJet removeWeapon 'PylonRack_Missile_AMRAAM_C_x2';
		_casJet removeWeapon 'PylonRack_Missile_AMRAAM_D_x2';
		{
			_casJet setObjectTextureGlobal _x;
		} forEach [

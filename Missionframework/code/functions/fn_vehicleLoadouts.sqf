...
if (_type isEqualTo 1) exitWith {
	...
	if (_vehicleType isEqualTo 'b_plane_fighter_01_f') then {
		//_vehicle call _preparePylons;
		{
			...
			[7,"PylonMissile_Missile_BIM9X_x1",TRUE],
			[8,"PylonMissile_Missile_BIM9X_x1",TRUE],
			[9,"",TRUE],
			[10,"",TRUE],
	...
	if (_vehicleType isEqualTo 'o_plane_fighter_02_f') then {
		//_vehicle call _preparePylons;
		{
			...
			[3,"PylonRack_1Rnd_GAA_missiles",TRUE],	/*/PylonMissile_Missile_AA_R77_x1/*/
			[4,"PylonRack_1Rnd_GAA_missiles",TRUE],	/*/PylonMissile_Missile_AA_R77_x1/*/
			...
			[9,"PylonRack_1Rnd_GAA_missiles",TRUE],	/*/PylonMissile_Missile_AA_R77_x1/*/
			[10,"PylonRack_1Rnd_GAA_missiles",TRUE],	/*/PylonMissile_Missile_AA_R77_x1/*/
			[11,"PylonMissile_Missile_AA_R73_x1",TRUE],
			[12,"PylonMissile_Missile_AA_R73_x1",TRUE],
	...
	if (_vehicleType isEqualTo 'i_plane_fighter_04_f') then {
		//_vehicle call _preparePylons;
		{
			...
			[1,"PylonMissile_Missile_BIM9X_x1",TRUE],
			[2,"PylonMissile_Missile_BIM9X_x1",TRUE],
			[3,"PylonRack_1Rnd_GAA_missiles",TRUE],
			[4,"PylonRack_1Rnd_GAA_missiles",TRUE],

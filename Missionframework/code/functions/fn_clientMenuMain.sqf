...
if (_type isEqualTo 'onLoad') exitWith {
	...
	(_display displayCtrl 1601) ctrlSetText 'Donator Perks';
	...
	(_display displayCtrl 1604) ctrlSetText 'Options';
	(_display displayCtrl 1604) ctrlSetToolTip '';
	(_display displayCtrl 1605) ctrlSetText 'Fix uniform';
	(_display displayCtrl 1605) ctrlSetToolTip 'Click when asked to fix your uniform';
	(_display displayCtrl 1606) ctrlSetText 'Close';
	(_display displayCtrl 1606) ctrlSetToolTip '';
};
...
if (_type isEqualTo 'B6') exitWith {
	closeDialog 2;
	['onUnload'] call (missionNamespace getVariable 'QS_fnc_clientMenuMain');
	[player] call (missionNamespace getVariable 'McD_fnc_uniformBug');
};
if (_type isEqualTo 'B7') exitWith {
	closeDialog 2;
	['onUnload'] call (missionNamespace getVariable 'QS_fnc_clientMenuMain');
};
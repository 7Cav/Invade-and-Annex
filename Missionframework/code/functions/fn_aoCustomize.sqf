...
if (worldName isEqualTo 'Altis') then {
	...
	if (_aoName isEqualTo 'dump') then {
		...
		if ((random 1) > 0) then {
			_entities = [[5976.48,20410.9,0],1,30,25,['APERSBoundingMine',0.5,'APERSMine',1,'ATMine',0],false,false] call (missionNamespace getVariable 'QS_fnc_createMinefield');
			{
				(missionNamespace getVariable 'QS_entities_ao_customEntities') pushBack _x;
			} forEach _entities;
		};
	...
	if (_aoName isEqualTo 'nidasos woodlands') then {
		...
		if ((random 1) > 0) then {
			_entities = [[23988.6,22331.8,0],1,15,25,['APERSBoundingMine',0.5,'APERSMine',0.333,'ATMine',0],false,false] call (missionNamespace getVariable 'QS_fnc_createMinefield');
			{
				(missionNamespace getVariable 'QS_entities_ao_customEntities') pushBack _x;
			} forEach _entities;
		};
	...
	if (_aoName isEqualTo 'sofia powerplant') then {
		...
		if ((random 1) > 0) then {
			_entities = [[26294.2,21722.4,0],1,20,20,['APERSBoundingMine',0.5,'APERSMine',0.333,'ATMine',0],false,false] call (missionNamespace getVariable 'QS_fnc_createMinefield');
			{
				(missionNamespace getVariable 'QS_entities_ao_customEntities') pushBack _x;
			} forEach _entities;
		};
	...
	if (_aoName isEqualTo 'skopos castle') then {
		if ((random 1) > 0) then {
			_entities = [[10397.7,8753.36,0],1,25,10,['APERSBoundingMine',0.5,'APERSMine',0.333,'ATMine',0],false,false] call (missionNamespace getVariable 'QS_fnc_createMinefield');
			{
				(missionNamespace getVariable 'QS_entities_ao_customEntities') pushBack _x;
			} forEach _entities;
		};
		if ((random 1) > 0) then {
			_entities = [[10987.5,7677.47,0],1,25,10,['APERSBoundingMine',0.5,'APERSMine',0.333,'ATMine',0],false,false] call (missionNamespace getVariable 'QS_fnc_createMinefield');
			{
				(missionNamespace getVariable 'QS_entities_ao_customEntities') pushBack _x;
			} forEach _entities;
		};
	...
	if (_aoName isEqualTo 'eginio') then {
		...
		if ((random 1) > 0) then {
			_entities = [[11659.7,7581.22,0],1,30,15,['APERSBoundingMine',0.5,'APERSMine',0.333,'ATMine',0],false,false] call (missionNamespace getVariable 'QS_fnc_createMinefield');
			{
				(missionNamespace getVariable 'QS_entities_ao_customEntities') pushBack _x;
			} forEach _entities;
		};
		if ((random 1) > 0) then {
			_entities = [[11090.2,7323.96,0],1,30,15,['APERSBoundingMine',0.5,'APERSMine',0.333,'ATMine',0],false,false] call (missionNamespace getVariable 'QS_fnc_createMinefield');
			{
				(missionNamespace getVariable 'QS_entities_ao_customEntities') pushBack _x;
			} forEach _entities;
		};

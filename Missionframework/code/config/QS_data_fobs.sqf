		...
		_return = [
			...
			[
				...
				["Land_RepairDepot_01_tan_F","a3\structures_f_tank\military\repairdepot\repairdepot_01_tan_f.p3d",[11854.2,22299.6,19.4647],[[0.000170507,0.999986,-0.00525156],[-0.0293479,0.0052543,0.999556]],0,0,2,[],{
					missionNamespace setVariable ['QS_module_fob_repairDepot',(_this # 0),TRUE];
				...
				["Land_Shed_Small_F","a3\structures_f\ind\shed\shed_small_f.p3d",[11804.2,22301.7,19.2171],[[-0.00236112,0.999997,0],[0,0,1]],0,0,2,[],{
					[_this # 0] spawn {
						private _building = _this # 0;
						private _worldPos = _building modelToWorldWorld [0.893555,-0.0437012,-1.23892];
						private _verticalOffsetWorld = getNumber(configfile >> "CfgVehicles" >> "B_supplycrate_F" >> "SimpleObject" >> "verticalOffsetWorld");
						_worldPos set [2, _verticalOffsetWorld + getTerrainHeightASL _worldPos];
						private _crate = createSimpleObject ['B_supplycrate_F', _worldPos];
						missionNamespace setVariable ['QS_analytics_entities_created',((missionNamespace getVariable 'QS_analytics_entities_created') + 1),FALSE];
						_crate attachTo [_building];
						_crate setDir 90;
						sleep 0.1;
						_crate setVariable ['QS_arsenal_object', TRUE, TRUE];
						_crate hideObjectGlobal TRUE;
						missionNamespace setVariable ['QS_module_fob_supplycrate',_crate,TRUE];

						private _verticalOffsetWorldBollard = getNumber(configfile >> "CfgVehicles" >> "Land_Bollard_01_F" >> "SimpleObject" >> "verticalOffsetWorld");
						{
							private _worldPos = _building modelToWorld _x;
							_worldPos set [2, _verticalOffsetWorldBollard + getTerrainHeightASL _worldPos];
							private _bollard = createSimpleObject ["Land_Bollard_01_F", _worldPos];
							missionNamespace setVariable ['QS_analytics_entities_created',((missionNamespace getVariable 'QS_analytics_entities_created') + 1),FALSE];
						} foreach [[4.10547,-2.39697,-1.61108], [4.09277,-0.181396,-1.61108], [4.02979,1.90381,-1.61108], [2.24707,3.98438,-1.61108], [0.164063,3.86865,-1.61108], [-2.05029,3.7998,-1.61108], [-1.93359,-4.3374,-1.61108], [0.280762,-4.26855,-1.61108], [2.36377,-4.15283,-1.61108]];
					};
				}],
